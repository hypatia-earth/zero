...
export const layer = defineLayer('rain',
  ...
  withConfig({
    density: 0.16, sizePx: 0.5625, fadeDuration: 3.0, minMm: 0.1,
    colors: {
      rain: [0.7, 0.85, 1.0], freezingRain: [0.6, 0.8, 0.95],
      snow: [1.0, 1.0, 1.0], wetSnow: [0.9, 0.92, 0.95],
      sleet: [0.85, 0.9, 0.95], icePellets: [0.8, 0.85, 0.95],
